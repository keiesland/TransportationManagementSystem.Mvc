...
namespace TransportationManagementSystem.Data.Grid
{
    ...
    public class GridBuilder
    {
        ...
        protected RideDictionary routes { get; set; }
        ...
        {
            session = sess;
            routes = session.GetObject<RideDictionary>(RouteKey) ?? new RideDictionary();
        }
        ...
        public GridBuilder(ISession sess, GridDTO values, string defaultSortField)
        {
            ...
            routes = new RideDictionary(); // clear previous route segment values
        ...
        public void SaveRouteSegments() =>
            session.SetObject<RideDictionary>(RouteKey, routes);
        ...
        public RideDictionary CurrentRoute => routes;
    }
